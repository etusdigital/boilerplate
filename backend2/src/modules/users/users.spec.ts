...
describe('UsersController (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    await accountRepository.save([
      { id: 1, name: 'Test Account 1', domain: 'test1.com' },
      { id: 2, name: 'Test Account 2', domain: 'test2.com' }
    ]);
  ...
  describe('POST /users', () => {
    it('should create a new user', async () => {
      ...
      expect(response.body.profileImage).toBe(newUser.profileImage);
  ...
  describe('GET /users', () => {
    it('should return an array of users', async () => {
      ...
      expect(response.body[2].email).toBe('user2@example.com');
    });
  });
